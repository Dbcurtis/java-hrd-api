...
@ClassPreamble(date="4/6/2010")
 class OmniRigSetFMCmd extends OmniRigCmdData {
     ...
     * @param values
     */
     OmniRigSetFMCmd(final String pmcmd,
     ...
     * @param radioID
     */
     OmniRigSetFMCmd(final String pmcmd, final String radioID) {
        super(pmcmd, radioID);
    }
    /**
     *
...
//    }
        ...
        StringBuilder sb = (new StringBuilder(super.toString())).replace(0, 2, "FMC: ");
        return sb.toString();
    }
}
