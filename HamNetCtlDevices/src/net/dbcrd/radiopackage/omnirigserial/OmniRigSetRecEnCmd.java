...
@ClassPreamble(date="4/6/2010")
 class OmniRigSetRecEnCmd extends OmniRigCmdData {
     ...
     * @param values
     */
     OmniRigSetRecEnCmd(final String pmcmd,
     ...
     * @param radioID
     */
     OmniRigSetRecEnCmd(final String pmcmd, final String radioID) {
        super(pmcmd, radioID);
    }
    @Override
...
//    }
    ...
    public String toString() {
        StringBuilder sb=(new StringBuilder(super.toString())).replace(0, 2, "RNC: ");
        return sb.toString();
    }
}
