...
class OmniRigSetUSBCmd extends OmniRigCmdData {
     ...
     * @param values
     */
     OmniRigSetUSBCmd(final String pmcmd,
     ...
     * @param radioID
     */
     OmniRigSetUSBCmd(final String pmcmd, final String radioID) {
        super(pmcmd, radioID);
    }
...
//    }
    ...
    public String toString(){
        StringBuilder sb = (new StringBuilder(super.toString())).replace(0, 2, "USBC: ");
        return sb.toString();
    }
}
